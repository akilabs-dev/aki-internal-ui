<template>
  <section
    class="flex h-screen items-center bg-gray-50 p-16 dark:bg-gray-700"
  ...
  >
    <div class="container flex flex-col items-center">
      <div class="flex max-w-md flex-col gap-6 text-center">
        ...
        <a
          href="/"
          class="rounded bg-purple-600 px-8 py-4 text-xl font-semibold text-gray-50 hover:text-gray-200"
        >
          Back to home
        </a>
      </div>
